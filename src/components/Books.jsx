                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 text-xs lg:text-sm">
                            ...
                            <button className="flex min-w-[132px] items-center justify-center gap-1 rounded-md py-1.5 lg:py-1.5 transition-all bg-[#DC2954]/[14%] text-[#DC2954] hover:bg-[#DC2954]/[24%]">
                                <svg
                                    width={16}
                                    height={14}
                                    viewBox="0 0 21 19"
