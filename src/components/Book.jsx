...
const Book = () => {
    ...
    const handleFavorite = () => {
        if (isFavorite) {
            setFavBtnStyles("flex min-w-[132px] items-center justify-center gap-1 rounded-md py-1.5 lg:py-1.5 transition-all bg-[#1C4336]/[14%] text-[#1C4336] hover:bg-[#1C4336]/[24%]");
        } else {
            setFavBtnStyles("flex min-w-[132px] items-center justify-center gap-1 rounded-md py-1.5 lg:py-1.5 transition-all bg-[#DC2954]/[14%] text-[#DC2954] hover:bg-[#DC2954]/[24%]");
        }
        ...
        <div className="space-y-3">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-xs lg:text-sm">
                    ...
                    <button className={favBtnStyles} onClick={handleFavorite}>
                        {
                            isFavorite ? favBtnSvg : unFavBtnSvg
                        }
                        Favourite
                    </button>
                </div>
