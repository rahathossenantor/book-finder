        ...
        <div className="space-y-3">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-xs lg:text-sm">
                    ...
                    <button className="flex min-w-[132px] items-center justify-center gap-1 rounded-md py-1.5 lg:py-1.5 transition-all bg-[#1C4336]/[14%] text-[#1C4336] hover:bg-[#1C4336]/[24%]">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
